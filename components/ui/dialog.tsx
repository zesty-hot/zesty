  ...
  return (
    <DialogPortal>
      ...
      <div className="fixed inset-0 z-50">
        <div className="flex h-dvh flex-col items-center justify-end overflow-hidden sm:justify-center sm:overflow-y-auto sm:p-4">
          <DialogPrimitive.Popup
            data-slot="dialog-popup"
            className={cn(
              "grid w-full min-w-0 gap-4 border bg-popover bg-clip-padding p-6 text-popover-foreground shadow-lg transition-[scale,opacity,translate] duration-200 ease-in-out will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0 max-sm:max-h-[80vh] max-sm:origin-bottom max-sm:overflow-y-auto max-sm:border-none max-sm:opacity-[calc(1-min(var(--nested-dialogs),1))] max-sm:data-ending-style:translate-y-4 max-sm:data-starting-style:translate-y-4 sm:origin-center sm:max-w-lg sm:-translate-y-[calc(1.25rem*var(--nested-dialogs))] sm:scale-[calc(1-0.1*var(--nested-dialogs))] sm:rounded-2xl sm:data-ending-style:scale-98 sm:data-starting-style:scale-98 dark:bg-clip-border",
